...
for file in `cat geant.list`
	...
	./bin/RunppTestAna -i '/gpfs01/star/pwg/elayavalli/ppRun12Embpicos/'$file -intype pico -c JetTree -trig ppJP2 -o 'Results/geant/Geant'$file -N -1 -pj 15 2000 -mj 1 -pc 0.2 30 -lja antikt -ec 1 -R 0.4 -geantnum 1 -hadcorr 0.5 -towunc 0 -fakeeff 1 
